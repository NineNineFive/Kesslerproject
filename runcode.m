...
for i=1:1:size(p,2)
    ...
    GM(i) = G*M;
    objsize(i) = randi([90000,100000],1,1);
    distance(i) = 0;
    collided(i) = 0;
    collided2(i) = 0;
    collided3(i) = 0;
...
clearvars id dt G v h G M GM tid pv x_0 y_0 v_0 r rh t x y values inverted vi i n objsize collided distance; 